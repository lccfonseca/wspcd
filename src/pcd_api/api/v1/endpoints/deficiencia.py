...
from pcd_api.repository.deficiencia_repository import list_deficiencias, retrieve_deficiencia_by_id, \
    create_new_deficiencia, update_deficiencia_by_id, delete_deficiencia_by_id
